          ...
          <div class="header">
            <div class="header-cover no-cover">
              <div class="caption">
                ...
                <p class="time">文章类型:<span>{{detail.ContentType}}</span></p>
              </div>
            </div>
          </div>
        ...
        <!--<div class="page-tail">-->
          <!--<block v-if="userData.nickName">-->
            <!--<form @submit="submit" report-submit='true'>-->
              ...
              <!--</div>-->
              <!--<div class="like-btn">-->
                <!--<image v-if="collect" class="like-btn-img" src="../../static/assets/collect.png"-->
                       <!--@click="_collectAction('noCollect')"></image>-->
                <!--<image v-else class="like-btn-img" src="../../static/assets/no-collect.png"-->
                       <!--@click="_collectAction('collect')"></image>-->
              <!--</div>-->
          ...
          <!--<div class="comment" v-for="(comment, index) in comments" :key="index">-->
            <!--<div class="comment-info">-->
              ...
              <!--<div class="comment-author-position">-->
                <!--<div-->
                  <!--@click="replyComment(comment.replyer.objectId,comment.replyer.nickName,comment.formID,comment.replyer.authData.weapp.openid)">-->
                  <!--<image src="../../static/assets/comment.png"-->
                         <!--style="width: 20px;height: 20px;margin-bottom: 7px;"></image>-->
                <!--</div>-->
                <!--<div>{{ index + 1 }}楼</div>-->
              <!--</div>-->
            <!--</div>-->
...
export default {
   ...
   methods: {
     // 获取文章详情
     async _getDetail (alias) {
       const data = await post('/blog/getPreviewContent', {
         alias: alias
       })
       this.detail = data
       this.loading = true
   ...
   //           authData: { weapp: { openid: userData.authData.weapp.openid } }
   //         }
   //         if (userId) {
